import { ArrowLeft, Calendar, Clock3, Download, Play, Star } from "lucide-react";
...
const MovieDetails = () => {
  ...
  const downloadSite = import.meta.env.VITE_MOVIE_DOWNLOAD_URL || "https://example.com/download";
  const downloadUrl = `${downloadSite}${downloadSite.includes("?") ? "&" : "?"}movie=${encodeURIComponent(movie.id)}`;
